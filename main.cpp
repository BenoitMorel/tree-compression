...
void simpleCompressionEqual(const char * tree_file) {
  ...
  simple_compression(tree_file, "output_files/succinct_tree.sdsl", "output_files/node_permutation.sdsl",
                      "output_files/branch_lengths_uncompressed.sdsl", 0/*PRINT_COMPRESSION*/);
  ...
  std::vector<double> branch_lengths = readDoubleVector("output_files/branch_lengths_uncompressed.sdsl");
  //std::vector<double> branch_lengths = loadBranchLengthsUncompressed("output_files/branch_lengths_uncompressed.sdsl");
...
void RFCompressionEqual(const char * tree_file1, const char * tree_file2) {
    ...
    rf_distance_compression(tree_file1, tree_file2, "output_files/edges_to_contract.sdsl",
                      ...
                      0 /*PRINT_COMPRESSION + PRINT_COMPRESSION_STRUCTURES*/);
    ...
    std::vector<double> consensus_branches = readDoubleVector("output_files/consensus_branches.sdsl");

    std::vector<double> non_consensus_branches = readDoubleVector("output_files/non_consensus_branches.sdsl");
    ...
    // std::cout << "Soll tree 2:\n";
    // printTree(root2);
    // std::cout << "Ist tree 2 RF Rekonstruktion:\n";
    // printTree(tree_rf);
